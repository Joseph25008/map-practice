...
if (__ES6Support() == true && version == '7') {
    ...
    document.write("<script src='" + l + "7/dg.js'></script>");
    ...
    document.write("<script src='" + l + "7/easymap.js'></script>");
