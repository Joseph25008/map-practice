 ...
 * 
 */
EzMap.HtmlStr = OpenLayers.Class({
     ...
     */
    initialize: function(htmlstr, mm, calculateOffset) {

		this.mm = mm;

        this.url = this.mm.root+"imgs/1px.png";
        this.size = {w: 20, h: 20};
        this.offset = {x: -(this.size.w/2), y: -(this.size.h/2)};
		this.offset = {x: 0, y: 0};
        ...
        this.imageDiv.innerHTML += "<div class='ezmap_htmlstr_marker' style='position:absolute;left:0px;top:0px;'>" + htmlstr + "</div>";
    },
