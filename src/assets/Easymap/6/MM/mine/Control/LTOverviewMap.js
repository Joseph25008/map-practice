EzMap.Control.LTOverviewMap = OpenLayers.Class(OpenLayers.Control.OverviewMap, {
    ...
    draw: function () {
        ...
        if (!this.outsideViewport) {
            ...
            // maximize button div
            var img = imgLocation + 'leftup.png';
			...
			OpenLayers.Event.observe(this.maximizeDiv, 'touchstart', OpenLayers.Function.bindAsEventListener(this.maximizeControl, this));
            this.div.appendChild(this.maximizeDiv);
            // minimize button div
            var img = imgLocation + 'rightdown.png';
            ...
            OpenLayers.Event.observe(this.minimizeDiv, 'touchstart', OpenLayers.Function.bindAsEventListener(this.minimizeControl, this));
    ...
    CLASS_NAME: "MM.Control.LTOverviewMap"
});