        ...
        for(var i=0, len=types.length; i<len; ++i) {
            ...
            switch (type.toLowerCase()) {
                ...
                case "polystyle":
                    ...
                    if (!style["strokeWidth"] && outline == "0") {//rextseng 如果linestyle有設定stroke了 這裡就不設定
                        style["strokeWidth"] = "1";
                    }
                ...
                case "iconstyle":
                    ...
                    //style["graphicHeight"] = height; //rex:自動長高
                    break;
    ...
    parseStyleMaps: function(nodes, options) {
        ...
        for(var i=0, len=nodes.length; i<len; i++) {
            ...
            for (var j=0, jlen=pairs.length; j<jlen; j++) {
                ...
                var wtfkey = this.parseProperty(pair, "*", base64_decode("a2V5")); //"key"
                var styleUrl = this.parseProperty(pair, "*", "styleUrl");

                if (styleUrl && wtfkey == "normal") {
