...
function CoordTrans() { 
		...
		this.toTM2_67 = function(){
			...
			case this.TM2_97:
			    var p3 = fromTM2(TWD97_A, TWD97_ECC, TWD97_ECC2, 0, this.degree, TWD97_TM2, this.x, this.y);
				var x3=p3[0];
				var y3=p3[1];
				...
				p2 = toTM2(TWD67_A, TWD67_ECC, TWD67_ECC2, 0, this.degree, TWD67_TM2, x1, y1);
			...
			case this.TWD67:
				...
				p = toTM2(TWD67_A, TWD67_ECC, TWD67_ECC2, 0, this.degree, TWD67_TM2, x1, y1);
			...
			default:
				...
				var p2 = toTM2(TWD67_A, TWD67_ECC, TWD67_ECC2, 0, this.degree, TWD67_TM2, x1, y1);
				p[0]=p2[0];
				p[1]=p2[1];
		...
		this.toTM2_97 = function(){
			...
			case this.TM2_67:
				...
				p1 = fromTM2(TWD67_A, TWD67_ECC, TWD67_ECC2, 0, this.degree, TWD67_TM2, x2, y2);
				x1=p1[0];
				y1=p1[1];
				...
				p = toTM2(TWD97_A, TWD97_ECC, TWD97_ECC2, 0, this.degree, TWD97_TM2, x3, y3);
		...
		this.toTWD67 = function(){
			...
			switch(this.fromCoord){
				case this.TM2_97:
					...
					p3 = fromTM2(TWD97_A, TWD97_ECC, TWD97_ECC2, 0, this.degree, TWD97_TM2, x4, y4);
					x3 = p3[0];
					y3 = p3[1];
				...
				case this.TM2_67:
					...
					p = fromTM2(TWD67_A, TWD67_ECC, TWD67_ECC2, 0, this.degree, TWD67_TM2, x2, y2);
		...
		this.toWGS84 = function(){
			...
			case this.TM2_97:
			    ...
			    p = fromTM2(TWD97_A, TWD97_ECC, TWD97_ECC2, 0, this.degree, TWD97_TM2, this.x, this.y);
				break;
			case this.TM2_67:



			    var p1 = fromTM2(TWD67_A, TWD67_ECC, TWD67_ECC2, 0, this.degree, TWD67_TM2, this.x, this.y);
